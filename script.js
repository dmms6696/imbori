...
const posters = [
  ...
  },
  {
    ...
    copy: "“모두 다 똑같아”",
    mainScene: "보리와 은정이가 나무 아래에 앉아 서로의 마음을 나누는 장면",
    description: "따뜻한 햇살과 커다란 나무 그늘 아래의 두 인물을 통해, 서로 다르게 들려도 같은 마음으로 이어질 수 있음을 표현한 포스터입니다.",
    intention: "2반은 영화 속 인물들이 서로를 특별하게 구분하기보다 있는 그대로 사랑하고 받아들이는 마음에 주목했습니다. 포스터에는 보리와 은정이가 나무 아래에 함께 앉아 있는 장면을 중심으로 배치해, 말소리보다 눈빛과 곁에 있어 주는 마음이 더 큰 소통이 될 수 있음을 담았습니다.",
    quotePreview: "“눈빛만으로도 소통을 할 수 있는 가족”",
    relatedReviews: [
      "있는 존재만으로 사랑하자",
      "눈빛만으로도 소통을 할 수 있는 가족",
      "가족의 눈빛도 나의 소리가 되는 영화"
    ]
  },
  {
    id: "class-3",
